...
constexpr bool can_eat_ghost(bool power_pellet_active, bool touching_ghost) {
...
// dot.
constexpr bool scored(bool touching_power_pellet, bool touching_dot) {
...
constexpr bool lost(bool power_pellet_active, bool touching_ghost) {
    return !power_pellet_active && touching_ghost;
}
...
constexpr bool won(bool has_eaten_all_dots, bool power_pellet_active,
         bool touching_ghost) {
